...
public class GuiLinearAcceleratorController extends LogicMultiblockControllerScreen<Accelerator, AcceleratorLogic, AcceleratorUpdatePacket, TileLinearAcceleratorController, BlockEntityMenuInfo<TileLinearAcceleratorController>, LinearAcceleratorLogic, ContainerLinearAcceleratorController> {
    ...
    public GuiLinearAcceleratorController(ContainerLinearAcceleratorController menu, Inventory inventory, Component title) {
    ...
    protected void drawForegroundLayer(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(font, cavitys, offset, topPos + 50, fontColor);
        ...
        guiGraphics.drawString(font, quadrupoles, offset, topPos + 60, fontColor);
