...
public class GuiDeceleratorController extends LogicMultiblockControllerScreen<Accelerator, AcceleratorLogic, AcceleratorUpdatePacket, TileDeceleratorController, BlockEntityMenuInfo<TileDeceleratorController>, DeceleratorLogic, ContainerDeceleratorController> {
    ...
    public GuiDeceleratorController(ContainerDeceleratorController menu, Inventory inventory, Component title) {
