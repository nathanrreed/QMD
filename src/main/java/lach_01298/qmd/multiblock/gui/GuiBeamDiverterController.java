...
public class GuiBeamDiverterController extends LogicMultiblockControllerScreen<Accelerator, AcceleratorLogic, AcceleratorUpdatePacket, TileBeamDiverterController, BlockEntityMenuInfo<TileBeamDiverterController>, BeamDiverterLogic, ContainerBeamDiverterController> {
    ...
    public GuiBeamDiverterController(ContainerBeamDiverterController menu, Inventory inventory, Component title) {
