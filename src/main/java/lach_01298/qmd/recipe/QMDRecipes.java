...
public class QMDRecipes {
    ...
    //    private static final Object2ObjectMap<String, QMDRecipeHandler> RECIPE_HANDLER_MAP = new Object2ObjectOpenHashMap<>(); TODO
...
//    }
//    public static List<QMDRecipe> getRecipeList(String name, Level level) {
...
//        putHandler(new AcceleratorCoolingRecipes());
        NCRecipes.putHandler(new MassSpectrometerRecipes());
...
//        accelerator_cooling = (AcceleratorCoolingRecipes) getHandler("accelerator_cooling");
        mass_spectrometer = NCRecipes.getHandler("mass_spectrometer");
...
//        for (QMDRecipeHandler handler : getHandlers()) { TODO
...
//    }
    ...
    public static class QMDProcessorRecipeHandler extends BasicProcessorRecipeHandler {
    ...
    public static class MassSpectrometerRecipes extends QMDProcessorRecipeHandler {
