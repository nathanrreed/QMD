...
//
//public record QMDRecipeInput(List<SizedChanceItemIngredient> itemIngredients, List<SizedChanceFluidIngredient> fluidIngredients, List<IParticleIngredient> particleIngredients) implements RecipeInput {
//    @Override
...
//        return particleIngredients.get(index).getStack();
//    }
//
//    @Override
//    public int size() {
...
//        return particleIngredients.size();
//    }
//
//    @Override
