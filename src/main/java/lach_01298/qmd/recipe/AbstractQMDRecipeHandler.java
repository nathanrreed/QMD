...
//
//    private static List<Class<?>> validItemInputs = Lists.newArrayList(SizedChanceItemIngredient.class, ArrayList.class, String.class, Item.class, Block.class, ItemStack.class, ItemStack[].class);
//    private static List<Class<?>> validFluidInputs = Lists.newArrayList(SizedChanceFluidIngredient.class, ArrayList.class, String.class, Fluid.class, FluidStack.class, FluidStack[].class);
...
//    private static List<Class<?>> validItemOutputs = Lists.newArrayList(SizedChanceItemIngredient.class, String.class, Item.class, Block.class, ItemStack.class);
//    private static List<Class<?>> validFluidOutputs = Lists.newArrayList(SizedChanceFluidIngredient.class, String.class, Fluid.class, FluidStack.class);
...
//    }
//
//    public @Nullable RECIPE getRecipeFromIngredients(List<SizedChanceItemIngredient> itemIngredients, List<SizedChanceFluidIngredient> fluidIngredients, List<IParticleIngredient> particleIngredients) {
...
//    }
//
//    public @Nullable RECIPE getRecipeFromProducts(List<SizedChanceItemIngredient> itemProducts, List<SizedChanceFluidIngredient> fluidProducts, List<IParticleIngredient> particleProducts) {
//        for (RECIPE recipe : recipeList) {
...
//        for (RECIPE recipe : recipeList) {
//            recipe.getItemIngredients().forEach(SizedChanceItemIngredient::init);
//            recipe.getFluidIngredients().forEach(SizedChanceFluidIngredient::init);
//            recipe.getParticleIngredients().forEach(IParticleIngredient::init);
//            recipe.getItemProducts().forEach(SizedChanceItemIngredient::init);
//            recipe.getFluidProducts().forEach(SizedChanceFluidIngredient::init);
...
//        List<List<ItemStack>> itemInputLists = StreamHelper.map(recipe.getItemIngredients(), SizedChanceItemIngredient::getInputStackHashingList);
//        List<List<FluidStack>> fluidInputLists = StreamHelper.map(recipe.getFluidIngredients(), SizedChanceFluidIngredient::getInputStackHashingList);
...
////
////			for (SizedChanceItemIngredient item : recipe.getItemIngredients())
////				itemInputLists.add(item.getInputStackHashingList());
////			for (SizedChanceFluidIngredient fluid : recipe.getFluidIngredients())
...
//        for (RECIPE recipe : recipeList) {
//            for (SizedChanceItemIngredient input : recipe.getItemIngredients()) {
...
//        for (RECIPE recipe : recipeList) {
//            for (SizedChanceFluidIngredient input : recipe.getFluidIngredients()) {
//                if (input.match(stack, IngredientSorption.NEUTRAL).matches()) {
//                    return true;
//                }
//            }
...
//        for (RECIPE recipe : recipeList) {
//            for (SizedChanceItemIngredient output : recipe.getItemProducts()) {
...
//        for (RECIPE recipe : recipeList) {
//            for (SizedChanceFluidIngredient output : recipe.getFluidProducts()) {
//                if (output.match(stack, IngredientSorption.OUTPUT).matches()) {
//                    return true;
//                }
//            }
