...
//
//    private static final ModConfigSpec.ConfigValue<List<? extends Boolean>> propertyRegisterTool = add(CATEGORY_TOOLS, "register_tool", List.of(true, true), true);
//    private static final ModConfigSpec.ConfigValue<List<? extends Integer>> propertyToolMiningLevel = add(CATEGORY_TOOLS, "tool_mining_level", List.of(3, 3, 4), 0, 15, true);
...
//
//
//    private static final ModConfigSpec.IntValue propertyCellLifetime = add(CATEGORY_TOOLS, "cell_lifetime", 200, 0, 6000);
//
//    private static final ModConfigSpec.DoubleValue propertyCellRadiation = add(CATEGORY_TOOLS, "cell_radiation", 102400.0, 0.0, Double.MAX_VALUE);// the radiation at 1 block radius or lower
//    private static final ModConfigSpec.DoubleValue propertyCellExplosionSize = add(CATEGORY_TOOLS, "cell_explosion_size", 5.0, 0.0, 1000.0);
//
//    private static final ModConfigSpec.ConfigValue<List<? extends Integer>> propertyHEVArmour = add(CATEGORY_TOOLS, "hev_armour", List.of(4, 7, 9, 4, 1, 3, 4, 1), 1, 25, true);
...
//
//
//    private static final ModConfigSpec.ConfigValue<List<? extends Double>> propertyFissionReflectorEfficiency = add(CATEGORY_FISSION, "reflector_efficiency", List.of(0.75D), 0D, 255D, true);
//    private static final ModConfigSpec.ConfigValue<List<? extends Double>> propertyFissionReflectorReflectivity = add(CATEGORY_FISSION, "reflector_reflectivity", List.of(0.75D), 0D, 1D, true);
...
//
//
//        register_tool = readBooleanArray(propertyRegisterTool);
//
//        tool_mining_level = readIntegerArray(propertyToolMiningLevel);
...
//
//        cell_lifetime = propertyCellLifetime.getAsInt();
//        cell_radiation = propertyCellRadiation.getAsDouble();
//        cell_explosion_size = propertyCellExplosionSize.getAsDouble();
//
...
//
//        fission_reflector_efficiency = readDoubleArray(propertyFissionReflectorEfficiency);
//        fission_reflector_reflectivity = readDoubleArray(propertyFissionReflectorReflectivity);
