...
import static lach_01298.qmd.tile.QMDTiles.TILE_DECAY_CHAMBER_CONTROLLER;
...
public class TileDecayChamberController extends TileParticleChamberPart implements IParticleChamberController<TileDecayChamberController> {
    protected final BlockEntityMenuInfo<TileDecayChamberController> info = BlockEntityInfoHandler.getTileContainerInfo("decay_chamber_controller");

    public TileDecayChamberController(BlockPos pos, BlockState state) {
        super(TILE_DECAY_CHAMBER_CONTROLLER.get(), pos, state);
    }
    ...
    @Override
    public BlockEntityMenuInfo<TileDecayChamberController> getContainerInfo() {
        return info;
    }
    ...
    public Component getDisplayName() {
        return Component.translatable(QMD.MOD_ID + ".menu.title.decay_chamber_controller");
    }
