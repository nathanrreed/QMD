...
public class BeamDiverterLogic extends AcceleratorLogic {
    ...
    public void onAcceleratorFormed() {
        ...
        if (!getWorld().isClientSide()) {
            ...
            positions.add(acc.getMiddleCoord().immutable());
                ...
                if (port.getOutwardFacing() != null) {
                    ...
                    if (tile != null) {
                        ...
                        if (otherStorage != null) {
                            ...
                            if (stack != null) {
                                if (multiblock.getWorld().getBlockEntity(port.getBlockPos().relative(face.getOpposite(), getThickness() - 1)) instanceof TileAcceleratorBeamPort) {
                                    TileAcceleratorBeamPort oppositePort = (TileAcceleratorBeamPort) multiblock.getWorld().getBlockEntity(port.getBlockPos().relative(face.getOpposite(), getThickness() - 1));
