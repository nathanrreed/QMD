...
import static lach_01298.qmd.tile.QMDTiles.TILE_ACCELERATOR_BEAM;

public class TileAcceleratorBeam extends TileAcceleratorPart implements IAcceleratorComponent {
    private boolean isFunctional;

    public TileAcceleratorBeam(final BlockPos position, final BlockState blockState) {
        super(TILE_ACCELERATOR_BEAM.get(), position, blockState, PartPosition.Type.Interior);
        isFunctional = false;
    }
