...
public class BlockAcceleratorIonCollector extends GenericDirectionalTooltipDeviceBlock<Accelerator, IAcceleratorPartType> {
    public BlockAcceleratorIonCollector(MultiblockPartProperties<IAcceleratorPartType> properties) {
        super(properties);
    }
